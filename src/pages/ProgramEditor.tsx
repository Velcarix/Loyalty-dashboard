...
export function ProgramEditor() {
  ...
  // El color de las letras no es editable: se calcula desde el fondo, igual que
  // en la vista previa, y aquí solo se muestra cuál quedó.
  const autoTextColor = getTextColorForBg(brandColorInput)
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="rounded-xl border border-slate-200 p-3">
                      <div className="flex items-center justify-between gap-3">
                        ...
                        <span className="inline-flex items-center gap-2 rounded-lg border border-slate-200 px-2 py-1">
                          <span aria-hidden="true" className="h-4 w-4 rounded-full border border-slate-300" style={{ backgroundColor: autoTextColor }} />
                          <span className="text-xs font-semibold text-slate-700">{autoTextColor === '#FFFFFF' ? 'Blanco' : 'Negro'}</span>
                        </span>
                      </div>
                      <p className="mt-1.5 text-xs leading-5 text-slate-500">Se elige solo: blanco o negro, el que mejor se lea sobre el fondo de la tarjeta. Cambia en la vista previa en cuanto ajustas el color principal. Afecta el nombre del programa, el contador, las etiquetas y el nombre del cliente en Apple Wallet y en la tarjeta web; Google Wallet aplica su propia regla de blanco o negro.</p>
                    </div>
                    <div>
